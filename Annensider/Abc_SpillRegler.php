  ...
  mysql_query("UPDATE FAQ SET Faq='$PostER',Dato='$FullDato',Stamp='$tiden',SistEndretAv='$brukernavn' WHERE Id LIKE '3'");
  ...
  $HentFAQ = mysql_query("SELECT * FROM FAQ WHERE Id LIKE '3'");
