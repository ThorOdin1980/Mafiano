  ...
  elseif($turns < '400') { echo PrintTeksten("Du har ikke nok poeng.",'1','Feilet'); } else { 
  $NySpenn = floor($penger - '70000000');
  $NyTurns = floor($turns - '400');
  ...
  mysql_query("UPDATE brukere SET penger='$NySpenn',turns='$NyTurns',aktiv_eller='$tiden_aktiv' WHERE brukernavn='$brukernavn'"); 
  ...
  if(!in_array('Kulefabrikk', $Butikker, true)) { echo "<div class=\"D_Over\" onclick=\"VisValg('Velg alternativ','Kulefabrikk','Gjelder_P')\">---> Kulefabrikk - 70.000.000 kr og 400 poeng</div>"; }
  if(!in_array('Båter', $Butikker, true)) { echo "<div class=\"D_Over\" onclick=\"VisValg('Velg alternativ','Båter','Gjelder_P')\">---> Båt butikk 50.000.000 kr og 400 poeng</div>"; }
  if(!in_array('Fly', $Butikker, true)) { echo "<div class=\"D_Over\" onclick=\"VisValg('Velg alternativ','Fly','Gjelder_P')\">---> Fly butikk 50.000.000 kr og 400 poeng</div>"; }
  if(!in_array('Våpen', $Butikker, true)) { echo "<div class=\"D_Over\" onclick=\"VisValg('Velg alternativ','Våpen','Gjelder_P')\">---> Våpen butikk 50.000.000 kr og 400 poeng</div>"; }
  if(!in_array('Beskyttelse', $Butikker, true)) { echo "<div class=\"D_Over\" onclick=\"VisValg('Velg alternativ','Beskyttelse','Gjelder_P')\">---> Beskyttelses butikk 50.000.000 kr og 400 poeng</div>";  }
