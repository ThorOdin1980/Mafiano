  ...
  if(empty($brukernavn)) { header("Location: index.php"); } else {
    botcheck_add_event($userinfo['brukerid'], $userinfo['brukernavn'], 'Brekk', 'brekk_funksjon5', time(), $db);
  ...
  $Meld = array("Du stjal $TjenFormat.","Du knuste tryne på kisen bak disken og dirka opp kassa, du stjal $TjenFormat.","Du knuste tryne til mannen bak disken og tok pengene i kassa, du tjente $TjenFormat.","Proft du gikk inn og bar med deg kassa hjem, du stjal $TjenFormat.","Den feite dama bak disken ble så redd at hun fjerta, du tjente $TjenFormat.");
  ...
  $Meld = array("Du ble busta.","Du ble tatt av en politimann.","Du ble tatt av en politidame.","Du ble tatt på veien hjem.","Politiet så deg og kastet deg i cella med en gang.","Det var en politimann på kinoen, du ble tatt.");
  $Meld = $Meld[array_rand($Meld)];
  ...
  $Meld = array("Det var ingen penger i kassa på kinoen, du knuste vinduet og stakk av. Du gikk opp i respekt.","Du banka opp 2-3 på kinoen, forsøket på å rane kinoen feilet men du gikk opp i respekt.","Mannen bak disken nektet å utlevere penga, du slo inn tryne hans og stakk av. Du gikk opp i respekt.","Du knuste det stygge tryne til den feite dama bak disken, du gikk opp i respekt men fikk ikke med deg noen penger.");
  $Meld = $Meld[array_rand($Meld)];
  ...
  $Meld = array("Du truet mannen bak disken men han dreit i det, du stakk.","Du feilet.","Det endte med at mannen bak kassa slo deg.","Du kom klokka tolv om dagen for å rane kinoen men kinoen var stengt.","Alt gikk feil, du stjal ingenting.","Misslykket du møtte en hore på veien og mistet konsetrasjonen.");
  $Meld = $Meld[array_rand($Meld)];
