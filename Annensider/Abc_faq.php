  ...
  <div class="Div_masta">
  <?
  if($type == 'A' || $type == 'm' || $type == 'sf' || $type == 's') { 
  ...
  mysql_query("UPDATE FAQ SET Faq='$PostER',Dato='$FullDato',Stamp='$tiden',SistEndretAv='$brukernavn' WHERE Id LIKE '1'");
  ...
  <div id="myInstance1" style="float:left; width:480px; margin:5px; min-height:200px;">
  <?

  $HentFAQ = mysql_query("SELECT * FROM FAQ WHERE Id LIKE '1'");
