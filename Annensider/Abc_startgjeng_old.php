       ...
       $Sjekk_GjengNavn = mysql_query("SELECT * FROM Gjenger WHERE Gjeng_Navn='$GjengNavn'");
        ...
        echo '<div class="Div_MELDING"><span class="Span_str_6">Gratulerer med gjeng, du betalte 200 millioner og 150 poeng. Gjengen din heter '.$GjengNavn.'.</span></div>';
        } else { echo '<div class="Div_MELDING"><span class="Span_str_5">Du har ikke nok poeng, en gjeng koster 200 millioner samt 150 poeng.</span></div>'; }
        } else { echo '<div class="Div_MELDING"><span class="Span_str_5">Du har ikke nok penger på hånda, en gjeng koster 200 millioner samt 150 poeng.</span></div>'; }
        }}}} 
