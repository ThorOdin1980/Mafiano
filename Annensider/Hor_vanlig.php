  ...
  if($Stilling == 'Doggystyle') { $Meld_0 = "Du knullet $PersTo rolig i rompa."; } 
  elseif($Stilling == 'Oralsex') { $Meld_0 = "Du ble sugd av $PersTo mens du strøk ham følsomt på håret."; }
  elseif($Stilling == 'Plogen' || $Stilling == 'Bindersen' || $Stilling == 'Lotus' || $Stilling == 'Myk misjonær') { $Meld_0 = 'Du utførte sex stillingen "'.strtolower($Stilling).'" med en mann.'; }
  } 
  elseif($Gir['Kjon'] == 'Jente' && $Tar['Kjon'] == 'Gutt') {
  if($Stilling == 'Doggystyle') { $Meld_0 = "$PersTo knullet deg mykt og rolig."; } 
  elseif($Stilling == 'Oralsex') { $Meld_0 = "$PersTo sleiket musa di."; }
  elseif($Stilling == 'Plogen' || $Stilling == 'Bindersen' || $Stilling == 'Lotus' || $Stilling == 'Myk misjonær') { $Meld_0 = 'Du utførte sex stillingen "'.strtolower($Stilling).'" med en mann.'; }
  }
  elseif($Gir['Kjon'] == 'Gutt' && $Tar['Kjon'] == 'Jente') { 
  if($Stilling == 'Doggystyle') { $Meld_0 = "Du knullet $PersTo forsiktig."; } 
  elseif($Stilling == 'Oralsex') { $Meld_0 = "$PersTo sugde deg."; }
  elseif($Stilling == 'Plogen' || $Stilling == 'Bindersen' || $Stilling == 'Lotus' || $Stilling == 'Myk misjonær') { $Meld_0 = 'Du utførte sex stillingen "'.strtolower($Stilling).'" med ei jente.'; }
  }
  elseif($Gir['Kjon'] == 'Jente' && $Tar['Kjon'] == 'Jente') { 
  if($Stilling == 'Doggystyle') { $Meld_0 = "Du og $PersTo pulte hverandre i rompa med strapon dildo."; } 
  elseif($Stilling == 'Oralsex') { $Meld_0 = "$PersTo sleika deg, ettervært fingret du henne forsiktig."; }
  elseif($Stilling == 'Plogen' || $Stilling == 'Bindersen' || $Stilling == 'Lotus' || $Stilling == 'Myk misjonær') { $Meld_0 = 'Du utførte sex stillingen "'.strtolower($Stilling).'" med ei anna jente.'; }
  }
