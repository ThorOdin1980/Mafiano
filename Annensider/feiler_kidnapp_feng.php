        ...
        $nytt_rankpros = $rankpros + '0.2';
 
        // Tekst blir valgt
        $endelig_svar2k = array("Du backa ut.", "Du feilet.", "Du fant ikke personen.");
        $endelig_svar = $endelig_svar2k[array_rand($endelig_svar2k)];
 
        // Tekst blir valgt melding
        $endelig_pm2k = array("$brukernavn prøvde å kidnappe deg men feilet.", "En anonym prøvde å kidnappe deg.", "$brukernavn fulgte etter deg men du klarte å riste han av deg.");
