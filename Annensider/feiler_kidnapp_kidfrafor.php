        ...
        $endelig_svar2k = array("Du fant ikke $kid_brukernavn i $land.", "Du fant ikke personen.");
        $endelig_svar = $endelig_svar2k[array_rand($endelig_svar2k)];
 
        $endelig_pm2k = array("$brukernavn hadde tenkt til å kidnappe deg men viste ikke at du allerede var kidnappet.", "En anonym prøvde å kidnappe deg men feilet siden du allerede er kidnappet.", "$brukernavn hadde planer om å kidnappe deg men fant deg ikke siden du er kidnappet fra før av.","En anonym forsøke å kidnappe deg men feilet siden du allerede er kidnappet.");
