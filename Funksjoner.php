...
// -- Function Name : InvLonn
// -- Params : $Rankniva,$Invitert
// -- Purpose : 
    function InvLonn($Rankniva,$Invitert)
    {
        global $Timestamp, $FullDato, $Aktiv, $brukernavn, $rank;
        
        if($Rankniva >= '3' && $Invitert != 'Ingen&ingeN')
        {
          
            mysql_query("UPDATE brukere SET turns=`turns`+'100',rankpros=`rankpros`+'5' WHERE brukernavn='$Invitert'");
            mysql_query("UPDATE brukere SET InvitertAv='Ingen&ingeN',aktiv_eller='$Aktiv' WHERE brukernavn='$brukernavn'");
          
            mysql_query("INSERT INTO pm_system (fra_bruker,til_bruker,timestampen,dato_sendt,tittel,melding,fra_game_ell) VALUES ('Game','$Invitert','$Timestamp','$FullDato','Poeng levert','Du har mottatt 100 poeng og 5 rankprosent siden $brukernavn som du har invitert til dette spillet har spilt seg opp til $rank.','Ja')");
        }
...
// -- Function Name : LoggUt
// -- Params : 
// -- Purpose : 
    function LoggUt()
    {
        global $Timestamp, $brukernavn;
      
        mysql_query("UPDATE brukere SET aktiv_eller='$Timestamp' WHERE brukernavn='$brukernavn'");
        session_unset();
        session_destroy();
...
// -- Function Name : SjekkPenger
// -- Params : 
// -- Purpose : 
    function SjekkPenger()
    {
        global $brukernavn, $Timestamp, $FullDato, $Aktiv, $penger, $bank;
      
        mysql_query("UPDATE brukere SET penger='0',bank='0',aktiv_eller='$Aktiv' WHERE brukernavn='$brukernavn'");
      
        mysql_query("INSERT INTO pm_system (fra_bruker,til_bruker,timestampen,dato_sendt,tittel,melding,fra_game_ell) VALUES ('Game','Havers','$Timestamp','$FullDato','VIKTIG!','$brukernavn fikk en sum lavere en null, pengene på hånda som var $penger kr samt pengene i banken som var $bank kr har blitt endret til null kroner.','Ja')");
        mysql_query("INSERT INTO pm_system (fra_bruker,til_bruker,timestampen,dato_sendt,tittel,melding,fra_game_ell) VALUES ('Game','$brukernavn','$Timestamp','$FullDato','Penger','Mafiano har tatt pengene du hadde kontant og de du hadde i banken, dette ble gjort av ren sikkerhet. Summen i banken/kontant var lavere en null, kontakt en medlem av MafiaNo Crew.','Ja')");
    }
